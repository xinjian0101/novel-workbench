...
The generated scripts complete top-level commands such as `create`, `stats`, `export`, and `backup`. They do not yet complete project slugs, file paths, or option values.
