...
def main() -> int:
    ...
    commands = [
        ...
        [sys.executable, "-m", "novel_workbench.cli", "--workspace", str(workspace), "export-dashboard", str(exports / "workspace-dashboard.md")],
        ...
        [sys.executable, "-m", "novel_workbench.cli", "--workspace", str(workspace), "pitch", "moon-archive"],
        [sys.executable, "-m", "novel_workbench.cli", "--workspace", str(workspace), "plan", "moon-archive"],
        [sys.executable, "-m", "novel_workbench.cli", "--workspace", str(workspace), "review", "moon-archive"],
        [sys.executable, "-m", "novel_workbench.cli", "--workspace", str(workspace), "revision", "moon-archive"],
        ...
        [sys.executable, "-m", "novel_workbench.cli", "--workspace", str(workspace), "export", "moon-archive", str(exports / "moon-archive-focus.md"), "--template", "focus"],
        [sys.executable, "-m", "novel_workbench.cli", "--workspace", str(workspace), "export", "moon-archive", str(exports / "moon-archive-handoff.md"), "--template", "handoff"],
        [sys.executable, "-m", "novel_workbench.cli", "--workspace", str(workspace), "export", "moon-archive", str(exports / "moon-archive-momentum.md"), "--template", "momentum"],
        [sys.executable, "-m", "novel_workbench.cli", "--workspace", str(workspace), "export", "moon-archive", str(exports / "moon-archive-board.md"), "--template", "board"],
        [sys.executable, "-m", "novel_workbench.cli", "--workspace", str(workspace), "export", "moon-archive", str(exports / "moon-archive-outline.md"), "--template", "outline"],
        [sys.executable, "-m", "novel_workbench.cli", "--workspace", str(workspace), "export", "moon-archive", str(exports / "moon-archive-pitch.md"), "--template", "pitch"],
        ...
        [sys.executable, "-m", "novel_workbench.cli", "--workspace", str(workspace), "social-card", "moon-archive", str(exports / "moon-archive-social-card.svg")],
        [sys.executable, "-m", "novel_workbench.cli", "--workspace", str(workspace), "launch-copy", "moon-archive", str(exports / "moon-archive-launch-copy.md")],
